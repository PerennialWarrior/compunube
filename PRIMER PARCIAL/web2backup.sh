...
cat <<TEST> /vagrant/Web2Backup/preseed.yaml
config: {}
networks: []
storage_pools: []
profiles: []
...
TEST
cat /vagrant/Web2Backup/preseed.yaml
sudo cat /vagrant/Web2Backup/preseed.yaml | lxd init --preseed
...
lxc init ubuntu:18.04 Web1Backup --target web1backup < /dev/null
...
lxc init ubuntu:18.04 Web2Backup --target web2backup < /dev/null
...
sudo lxc file push /vagrant/Web1Backup/index.html Web1Backup/var/www/html/index.html
...
sudo lxc file push /vagrant/Web2Backup/index.html Web2Backup/var/www/html/index.html
